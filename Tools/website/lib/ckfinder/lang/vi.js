...
{
	// appTitle : 'CKFinder',
	appTitle : 'CKFinder reVietnamese by bil4i3n',
	...
	FilesDelete	: 'Bạn có chắc chắn xóa vĩnh viễn %1 tập tin?', // MISSING
	FilesLoading	: 'Đang tải...',
	FilesEmpty		: 'Thư mục trống.',
	// DestinationFile	: 'Destination File', // MISSING
	DestinationFile	: 'Tập tin đích', // MISSING
	// SkippedFiles	: 'List of skipped files:', // MISSING
	SkippedFiles	: 'Danh sách các tập tin đã bỏ qua:', // MISSING

	// Basket
	// BasketFolder		: 'Rổ',
	BasketFolder		: 'Global Folder',
	BasketClear			: 'Dọn rổ',
	...
	BasketRemoveConfirmMultiple	: 'Bạn có chắc chắn muốn xóa %1 tập tin khỏi thư mục dùng chung này?', // MISSING
	BasketEmpty			: 'Không có tập tin trong rổ, hãy kéo và thả tập tin vào rổ.',
	BasketCopyFilesHere	: 'Sao chép tập tin từ rổ',
	BasketMoveFilesHere	: 'Chuyển tập tin từ rổ',

	// Global messages
	// OperationCompletedSuccess	: 'Operation completed successfully.', // MISSING
	OperationCompletedSuccess	: 'Quá trình xử lý thành công.', // MISSING
	// OperationCompletedErrors		: 'Operation completed with errors.', // MISSING
	OperationCompletedErrors		: 'Quá trình xử lý phát sinh lỗi.', // MISSING
	FileError				: '%s: %e', // MISSING

	// Move and Copy files
	// MovedFilesNumber		: 'Number of files moved: %s.', // MISSING
	MovedFilesNumber		: 'Số lượng tập tin đã được di chuyển: %s.', // MISSING
	// CopiedFilesNumber	: 'Number of files copied: %s.', // MISSING
	CopiedFilesNumber	: 'Số lượng tập tin đã được sao chép: %s.', // MISSING
	// MoveFailedList		: 'The following files could not be moved:<br />%s', // MISSING
	MoveFailedList		: 'Danh sách các tập tin đã không được di chuyển:<br />%s', // MISSING
	// CopyFailedList		: 'The following files could not be copied:<br />%s', // MISSING
	CopyFailedList		: 'Danh sách các tập tin đã không được sao chép:<br />%s', // MISSING
	...
	DeleteFiles		: 'Xóa nhiều tập tin', // MISSING
	...
	ManuallyRename	: 'Đổi tên bằng tay', // MISSING
	...
	111 : 'Có thể cấu hình tổng dung lượng cho phép tải lên nhỏ hơn dung lượng hiện tại của tập tin.', // MISSING
	...
	Zip :
	{
		...
		extractHereLabel	: 'Giải nén ở đây', // MISSING
		// extractToLabel		: 'Extract to...', // MISSING
		extractToLabel		: 'Giản nén đến...', // MISSING
		// downloadZipLabel	: 'Download as zip', // MISSING
		downloadZipLabel	: 'Nén thành Zip và tải về', // MISSING
		// compressZipLabel	: 'Compress to zip', // MISSING
		compressZipLabel	: 'Nén lại với định dạng Zip', // MISSING
		// removeAndExtract	: 'Remove existing and extract', // MISSING
		removeAndExtract	: 'Xóa thư mục(tập tin) nếu tồn tại và giải nén', // MISSING
		// extractAndOverwrite	: 'Extract overwriting existing files', // MISSING
		extractAndOverwrite	: 'Giải nén và chép đè', // MISSING
		// extractSuccess		: 'File extracted successfully.' // MISSING
		extractSuccess		: 'Giải nén tập tin thành công.' // MISSING
	},
