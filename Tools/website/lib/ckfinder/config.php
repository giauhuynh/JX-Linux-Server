...
function CheckAuthentication()
{
	...
	if(isset($_SESSION['ad_l']) && $_SESSION['ad_l']){
		return true;
	}
...
$config['Thumbnails'] = Array(
		// 'url' => $baseUrl . '_thumbs',
		'url' => $baseUrl . 'zz_thumbnails',
		// 'directory' => $baseDir . '_thumbs',
		'directory' => $baseDir . 'zz_thumbnails',
		'enabled' => true,
		'directAccess' => false,
		'maxWidth' => 100,
		'maxHeight' => 100,
...
$Permissions_ResourceType = ($Permissions <= 2)?'*':'Images';
$Permissions_Folder = ($Permissions <= 2)?'/':'/';
$Permissions_Folder_Create = ($Permissions <= 3)?true:false;
$Permissions_Folder_Rename = ($Permissions == 1)?true:false;
$Permissions_Folder_Delete = ($Permissions == 1)?true:false;
$Permissions_File_Upload = ($Permissions <= 3)?true:false;
$Permissions_File_Rename = ($Permissions == 1)?true:false;
$Permissions_File_Delete = ($Permissions == 1)?true:false;

$config['AccessControl'][] = Array(
		'role' => '*',
		'resourceType' => $Permissions_ResourceType,
		'folder' => $Permissions_Folder,

		'folderView' => true,
		'folderCreate' => $Permissions_Folder_Create,
		'folderRename' => $Permissions_Folder_Rename,
		'folderDelete' => $Permissions_Folder_Delete,

		'fileView' => true,
		'fileUpload' => $Permissions_File_Upload,
		'fileRename' => $Permissions_File_Rename,
		'fileDelete' => $Permissions_File_Delete);
...
$config['ResourceType'][] = Array(
		...
		// 'maxSize' => 0,
		'maxSize' => "100M",
		'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip,bil4i3n',
		'deniedExtensions' => '');
...
$config['ResourceType'][] = Array(
		...
		'directory' => $baseDir . 'compress',
		'maxSize' => 0,
		'allowedExtensions' => '7z,gz,gzip,rar,tar,tgz,zip',
		'deniedExtensions' => '');
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'mp4,flv,mov,mpeg,wmv',
		'deniedExtensions' => '');
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'mp3,mov,wma',
		'deniedExtensions' => '');

$config['ResourceType'][] = Array(
		'name' => 'Document',
		'url' => $baseUrl . 'document',
		'directory' => $baseDir . 'document',
		'maxSize' => 0,
		'allowedExtensions' => 'doc,docx,pdf,ppt,pptx,xls,xlsx,txt',
		'deniedExtensions' => '');
