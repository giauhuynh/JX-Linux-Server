...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	local a = {
		[1] = "Doat Co Co Dinh (seizeflag)",
		[2] = "Doat Co Ngau Nhien (seizeflag)",
		[3] = "Bao Ve Nguyen Soai",
		[4] = "Doat Co Co Dinh (seizeflag)",
		[5] = "Doat Co Ngau Nhien (seizeflag)",
		[6] = "Bao Ve Nguyen Soai",
		[7] = "Cuu Sat",
		[8] = "Van Luong",
		[9] = "Thap Tien",
		[10] = "Boss",
		[11] = "Quoc Chien",
		[9999] = "Bao Ve Nguyen Soai - CTC",
	}
	
	OutputMsg( "========> [TYPE] [SONG JIN] : "..(a[nRuleID] and a[nRuleID] or a[9999]).." <========" )
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------
