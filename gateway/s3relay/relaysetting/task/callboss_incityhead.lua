...
function qy_makeboss_onlyone_pos()
	...
	zMsg2SubWorld = format("Boss <color=yellow>%s<color> xuÊt hiÖn t¹i <color=green>%s<color> täa ®é <color=Water>(%d, %d)<color>.", bossname, worldname, floor(posx/8), floor(posy/16))
