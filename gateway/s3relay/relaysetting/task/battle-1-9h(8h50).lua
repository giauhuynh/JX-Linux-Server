	...
	OutputMsg( " =========================Chien truong Tong - Kim So Cap 8 : 50 khoi dong --->")
	OutputMsg( " =========================Chien truong Tong - Kim Trung Cap 8 : 50 khoi dong --->")
	OutputMsg( " =========================Chien truong Tong - Kim Cao Cap 8 : 50 khoi dong --->")
