...
function TaskContent()
	...
	local nlid = LG_GetLeagueObj(LEAGUETYPE_CITYWAR_FIRST, Bil_LG_CN_TB_CITYWAR_ARRANGE[i][3]);
	...
	LGM_ApplyRemoveMember(LEAGUETYPE_CITYWAR_FIRST, Bil_LG_CN_TB_CITYWAR_ARRANGE[i][3], szMemberName, "", "", 0);

	end;

	end;

	nlid = LG_GetLeagueObj(LEAGUETYPE_CITYWAR_SIGN, Bil_LG_CN_TB_CITYWAR_ARRANGE[i][3]);
	...
	LGM_ApplyRemoveMember(LEAGUETYPE_CITYWAR_SIGN, Bil_LG_CN_TB_CITYWAR_ARRANGE[i][3], tbTemMem[k], "", "", 0);
	...
	return Bil_LG_CN_TB_CITYWAR_ARRANGE[nCityID][3];
