...
function main()
	...
	if ((Uworld122 < 10) and (GetLevel() >= 90) and (Uworld38 == 127) and (GetReputeLevel(GetRepute()) >= 5) and (GetFaction() ~="shaolin" )) or ((GetLevel() >= 90) and (GetCamp() == 4) and (GetTask(5898) == 0)) then
