...
function main(sel)
	...
	if ((UTask_world37==0) and (GetLevel() >= 2)) then		-- ÒªÇóµÈ¼¶³¬¹ı2¼¶
		Say("Th»ng Ng­u Ng­u nhµ ta thİch lµm ®¹i hiÖp, kh«ng biÕt b©y giê l¹i ch¹y ®i ®©u råi",2,"§õng lo l¾ng ta gióp tÈu t×m/yes", "T×m kh«ng ra/no")
	elseif (UTask_world37==2) then
		Talk(1,"","PhiÒn ng­¬i t×m Ng­u Ng­u gióp ta.")
	else
...
function yes()
	Talk(1,"","Ng­¬i thËt lµ ng­êi tèt, vËy th× lµm phiÒn ng­¬i gióp ta nhĞ.")
	SetTask(65,2)
