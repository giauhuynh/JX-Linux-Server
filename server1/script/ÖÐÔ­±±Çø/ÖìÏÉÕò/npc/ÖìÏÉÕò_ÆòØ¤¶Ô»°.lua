...
function main()
	...
	if (UTask_world40 == 2) then
		Talk(6,"","Nghe nãi ng­¬i nhÆt ®­îc chiÕc nhÉn. §ã lµ cña Song Song c« n­¬ng trong th«n ®¸nh r¬i, ng­¬i cã thÓ tr¶ l¹i kh«ng?","Ta ch¼ng cã g× ¨n c¶, ph¶i cho ta c¸i g× míi ®­îc","Ng­¬i ch¼ng ph¶i ¨n c¬m sao?....thÕ ng­¬i muèn g×?.","Ta muèn ¨n mét phÇn ®Ëu hò Ngò H­¬ng","Ng­¬i ®ßi hái nhiÒu qu¸ ®Êy.","Muèn hay kh«ng muèn, ng­¬i tù quyÕt ®Şnh ®i.")
	...
	elseif ((UTask_world40 == 3) and (HaveItem(187) == 1)) then
		Talk(3,"","§Ëu phô Ngò H­¬ng cña ng­¬i ®©y","A! §óng lµ ®Ëu phô Ngò H­¬ng chİnh t«ng Chu Tiªn råi, th¬m qu¸!","§­îc! VËy ®­a nhÉn cho ta.")
		DelItem(187)
		AddEventItem(191)
		Msg2Player("§­a ®Ëu phô Ngò H­¬ng cho ng­êi ¨n mµy, lÊy ®­îc nhÉn cho Song Song c« n­¬ng. ")
