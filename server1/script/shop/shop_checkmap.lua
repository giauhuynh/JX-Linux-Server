...
function main()
	-- do return Talk(1,"","Cöa hµng b¶o vËt hiÖn ch­a cã th«ng tin!") end
	
	if (CheckGlobalTradeFlag() == 0) then		-- È«¾Ö¾­¼ÃÏµÍ³½»Ò×¿ª¹Ø
		return
	end
	
	if (bilOpenShopKTC ~= 1) then
		Msg2Player("<color=yellow>Kú tr©n c¸c hiÖn t¹i vÉn ch­a b¸n vËt phÈm!<color>")
		return 0
	end
