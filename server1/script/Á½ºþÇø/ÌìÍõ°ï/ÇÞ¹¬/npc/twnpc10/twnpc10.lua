...
function main()
	...
	-- end
	-- if GetTask(5995) == 1 then -- thien vuong
	...
	-- tbDailog:AddOptEntry("§Ö tö muèn b¸i nghÖ ®Çu s­ vµo Thiªn v­¬ng bang!", bilPartner2Sect, {2})
	...
	-------------------------------------------------------------------------
	if bilFunc_ChuongMonThapDaiPhai(2, GetLevel(), GetLastFactionNumber(), GetFaction(), GetName()) then
	
		local a, b = bilFunc_ChuongMonThapDaiPhai(2, GetLevel(), GetLastFactionNumber(), GetFaction(), GetName())
	...
	tinsert(tbDes, "§Ö tö muèn b¸i nghÖ ®Çu s­ vµo Thiªn v­¬ng bang!!/#bilPartner2Sect(2)")
...
function bil4i3nXS()
	...
	Msg2Faction("tianwang", GetName().." tõ h«m nay rêi khái s­ m«n, xuèng nói hµnh tÈu giang hå, mong c¸c huynh ®Ö chØ gi¸o!", GetName()) -----------
...
function bil4i3nXS_Return()
	...
	if GetTask(5995) ~= 1 and nTongID ~= 0 then ----------
		return Talk(1,"","Ng­êi cña gi¸o ph¸i kh¸c t¹i sao l¹i ®Õn ®©y nhê cËy ta?")
	end
	if(GetCash() >= 50000) then						
		Msg2Faction("tianwang", GetName().." tõ h«m nay trë vÒ l¹i s­ m«n, mong c¸c huynh ®Ö chØ gi¸o!", GetName()) ----------
		Talk(1,"","RÊt tèt! Hoan nghªnh ng­¬i trë l¹i Thiªn V­¬ng Bang!")
		Pay(50000)
		SetTask(5995, 0)
		SetFaction("tianwang") ------------------
		SetCamp(3) -------------------
