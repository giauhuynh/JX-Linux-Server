...
if (i == 1) then
Say("D­¬ng c«ng tö vâ nghÖ cao c­êng, tµi trİ h¬n ng­êi, Thiªn V­¬ng Bang d­íi bµn tay l·nh ®¹o cña anh ta, ngµy cµng ph¸t triÓn, rÊt ®­îc lßng cña b¸ t¸nh. Nh­ng tõ tr­íc ®Õn giê ta ch­a tõng ®­îc thÊy mÆt thËt cña D­¬ng C«ng Tö, nghe nãi ®ã lµ mét thiÕu niªn kh«i ng« tuÊn tó. ",0)
return
end;
