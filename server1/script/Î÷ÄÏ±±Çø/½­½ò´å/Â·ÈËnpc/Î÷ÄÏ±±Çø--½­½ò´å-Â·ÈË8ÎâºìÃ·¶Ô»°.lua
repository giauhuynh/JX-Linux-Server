...
function main(sel)
	...
	if (UTask_world21 == 3) then
		Talk(1,"","§a ta ng­¬i ®· hèt thuèc cho cha ta! §©y lµ ®«i giµy ta míi võa may xong, nÕu ng­¬i kh«ng chª xin h·y cÇm lÊy!")
		SetTask(49, 10)
		AddRepute(6)
		...
		Talk(1,"","MÑ ta muèn ¨n thŞt heo luéc tái, nh­ng ng­êi b¸n thŞt heo h×nh nh­ ch­a dän ra, vËy ph¶i lµm thÕ nµo míi ®­îc ®©y?")
	end
end;
