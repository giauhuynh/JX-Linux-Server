...
function Uworld123_prise()
	if GetLastFactionNumber() == 2 and (GetTask(123) == 70 or GetTask(123) == 75) and GetTask(5896) ~= 255 then
		if (HaveMagic(302) == -1) then		-- 
			AddMagic(302,1)
		end
		if (HaveMagic(339) == -1) then		-- 
			AddMagic(339,1)
		end
		...
		Msg2Player("Häc ®­îc kü n¨ng §­êng M«n: B·o vò lª hoa, nhiÕp hån nguyÖt ¶nh, Cöu cung phi tinh, lo¹n hoµn kİch.")
		SetTask(123,255)
		SetTask(5896,255)
	else
	   SetTask(123,245)  
   ...
   Msg2Player("Hoµn thµnh nhiÖm vô. Danh väng cña b¹n t¨ng thªm. "..add_repute.."®iÓm.")
   AddNote("Hoµn thµnh nhiÖm vô. Danh väng cña b¹n t¨ng thªm. "..add_repute.."®iÓm.")
end
