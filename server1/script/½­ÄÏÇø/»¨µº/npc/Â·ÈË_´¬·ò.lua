...
function main()
	...
	if (AEXP_IsFreeTimeDoubleExp() == 1) then-- Ãâ·ÑË«¾­ÑéÈÕ×Ó
		...
		Say("NÕu nh­ ng­¬i muèn rêi khái ®¶o nµy th× ph¶i mÊt 1800 l­îng", 2, "§©y 1800 l­îng ta cã ®©y, mau ®­a ta vÒ/go_yes", "ta ch­a muèn vÒ/no")		
		return 1;
	end
...
function go_yes()
	if (GetCash() >= 1800) then
		...
		Talk(1,"","ÒKh«ng cã tiÒn mµ còng ®ßi ngåi xe? <pic=15>, gäi ng­êi cã thÈm quyÒn ®Õn ®ãn ng­¬i vÒ, nghÌo thÕ ch¶ biÕt <pic=0>")
	end
end;
