...
map_lnpc = {
	-- 1
	{1, {1.5, 0, nil},
		{nil, 975, "S­¬ng §ao ", 15, -1, 0, 16, func_npc_getpos}},
	-- 2
	{1, {1.5, 0, nil},
		{nil, 976, "Phi Sa", 15, -1, 0, 16, func_npc_getpos}},
	-- 3
	{1, {3, 0, nil},
		{nil, 977, "S­¬ng Liªm", 15, -1, 0, 20, func_npc_getpos}},
	-- 4
	{2,	{9, 0, nil},
		{nil, 975, "S­¬ng §ao ", 15, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 75, func_npc_getseries, 1, 1, {1568, 3227}}
		},
	-- 5
	{1, {3, 0, nil},
		{nil, 978, "Thõa Phong", 15, -1, 0, 20, func_npc_getpos}},
	-- 6
	{1, {4.5, 0, nil},
		{nil, 979, "Thñy Hån", 15, 1, 0, 24, func_npc_getpos}},
	-- 7
	{1, {4.5, 0, nil},
		{nil, 980, "ThÇn Tı ", 15, 3, 0, 24, func_npc_getpos}},
	-- 8
	{2,	{6, 10, nil},
		{nil, 976, "Phi Sa", 15, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 75, func_npc_getseries, 1, 1, {1568, 3227}}
		},
	-- 9
	{1, {5, 0, nil},
		{nil, 981, "Tranh H¸n", 20, 2, 0, 32, func_npc_getpos}},
	-- 10
	{1, {5, 0, nil},
		{nil, 982, "Ph¸ Lang", 20, 4, 0, 32, func_npc_getpos}},
	-- 11
	{2,	{9, 0, nil},
		{nil, 977, "S­¬ng Liªm", 20, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 75, func_npc_getseries, 1, 1, {1568, 3227}}},
	-- 12
	{1, {6, 0, nil},
		{nil, 983, "¶nh C«n", 20, 0, 0, 40, func_npc_getpos}},
	-- 13
	{2,	{6, 10, nil},
		{nil, 978, "Thõa Phong", 20, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 75, func_npc_getseries, 1, 1, {1568, 3227}}
		},
	-- 14
	{1,	{4.5, 0, nil},
		{nil, 987, "Giang TrÇm YÕn", 20, -1, 0, 20, func_npc_getpos}},
	-- 15
	{1,	{6, 0, nil},
		{nil, 984, "§ao Tö ", 20, -1, 0, 32, func_npc_getpos}},
	-- 16
	{2,	{9, 0, nil},
		{nil, 979, "Thñy Hån", 20, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 75, func_npc_getseries, 1, 1, {1568, 3227}}},
	-- 17
	{1,	{4.5, 0, nil},
		{nil, 988, "C« Dù  TÈu", 25, -1, 0, 20, func_npc_getpos}},
	-- 18
	{2,	{6, 10, nil},
		{nil, 980, "ThÇn Tı ", 25, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 75, func_npc_getseries, 1, 1, {1568, 3227}}
		},
	-- 19
	{1,	{4.5, 0, nil},
		{nil, 989, "Ch­ëng B¸t Ph­¬ng", 25, -1, 0, 20, func_npc_getpos}},
	-- 20
	{1,	{6, 0, nil},
		{nil, 985, "Lang bæng", 25, -1, 0, 24, func_npc_getpos}},
	-- 21
	{2,	{10.5, 0, nil},
		{nil, 981, "Tranh H¸n", 25, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 75, func_npc_getseries, 1, 1, {1568, 3227}}},
	-- 22
	{1,	{4.5, 0, nil},
		{nil, 990, "TiÔn Than Thª ", 25, -1, 0, 20, func_npc_getpos}},
	-- 23
	{1,	{4.5, 0, nil},
		{nil, 991, "NhËm T«ng Hoµnh", 25, -1, 0, 20, func_npc_getpos}},
	-- 24
	{1,	{7.5, 30, nil},
		{nil, 992, "§å Tµn Sinh", 25, -1, 0, 20, func_npc_getpos}},
	-- 25
	{2,	{9, 0, nil},
		{nil, 984, "§ao Tö ", 25, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 75, func_npc_getseries, 1, 1, {1568, 3227}}},
	-- 26
	{1, {7.5, 0, nil},
	...
	{2, {24, 15, nil},
		...
		{nil, 985, "Lang bæng", 25, -1, 0, 16, func_npc_getpos}},
	-- 28
	{1, {0, 0, nil},
		{nil, 993, func_npc_get_eachname, 1, -1, 1, 8, func_npc_getpos}}, -- ph¶n ®oµn s¬ cÊp
		-- {nil, 986, func_npc_get_eachname, 75, -1, 1, 8, func_npc_getpos}},
};
...
map_hnpc = {
	-- 1
	{1, {2, 0, nil},
		{nil, 1007, "S­¬ng §ao ", 25, -1, 0, 16, func_npc_getpos}},
	-- 2
	{1, {2, 0, nil},
		{nil, 1008, "Phi Sa", 25, -1, 0, 16, func_npc_getpos}},
	-- 3
	{1, {3, 0, nil},
		{nil, 1009, "S­¬ng Liªm", 25, -1, 0, 20, func_npc_getpos}},
	-- 4
	{2, {9, 0, nil},
		{nil, 1007, "S­¬ng §ao ", 25, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 80, func_npc_getseries, 1, 1, {1568, 3227}}
		},
	-- 5
	{1, {3, 0, nil},
		{nil, 1010, "Thõa Phong", 30, -1, 0, 20, func_npc_getpos}},
	-- 6
	{1, {5, 0, nil},
		{nil, 1011, "Thñy Hån", 30, 1, 0, 24, func_npc_getpos}},
	-- 7
	{1, {5, 0, nil},
		{nil, 1012, "ThÇn Tı ", 30, 3, 0, 24, func_npc_getpos}},
	-- 8
	{2, {9, 15, nil},
		{nil, 1008, "Phi Sa", 30, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 80, func_npc_getseries, 1, 1, {1568, 3227}}
		},
	-- 9
	{1, {6, 0, nil},
		{nil, 1013, "Tranh H¸n", 35, 2, 0, 32, func_npc_getpos}},
	-- 10
	{1, {6, 0, nil},
		{nil, 1014, "Ph¸ Lang", 35, 4, 0, 32, func_npc_getpos}},
	-- 11
	{2, {12, 0, nil},
		{nil, 1009, "S­¬ng Liªm", 35, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 80, func_npc_getseries, 1, 1, {1568, 3227}}},
	-- 12
	{1, {9, 0, nil},
		-- {nil, 1015, "¶nh C«n", 35, 0, 0, 32, func_npc_getpos}},
		{nil, 1017, "¶nh C«n", 80, 0, 0, 32, func_npc_getpos}},
	-- 13
	{2, {9, 15, nil},
		{nil, 1010, "Thõa Phong", 35, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 80, func_npc_getseries, 1, 1, {1568, 3227}}
		},
	-- 14
	{1, {6, 0, nil},
		{nil, 1019, "Giang TrÇm YÕn", 35, -1, 0, 20, func_npc_getpos}},
	-- 15
	{1, {9, 0, nil},
		-- {nil, 1016, "§ao Tö ", 35, -1, 0, 32, func_npc_getpos}},
		{nil, 1016, "§ao Tö ", 80, -1, 0, 32, func_npc_getpos}},
	-- 16
	{2, {14, 0, nil},
		{nil, 1011, "Thñy Hån", 35, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 80, func_npc_getseries, 1, 1, {1568, 3227}}},
	-- 17
	{1, {6, 0, nil},
		{nil, 1020, "C« Dù  TÈu", 35, -1, 0, 20, func_npc_getpos}},
	-- 18
	{2, {12, 20, nil},
		{nil, 1012, "ThÇn Tı ", 35, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 80, func_npc_getseries, 1, 1, {1568, 3227}}
		},
	-- 19
	{1, {6, 0, nil},
		{nil, 1021, "Ch­ëng B¸t Ph­¬ng", 20, -1, 0, 20, func_npc_getpos}},
	-- 20
	{1, {8, 0, nil},
		-- {nil, 1017, "Lang bæng", 35, -1, 0, 24, func_npc_getpos}},
		{nil, 1017, "Lang bæng", 80, -1, 0, 24, func_npc_getpos}},
	-- 21
	{2, {14, 0, nil},
		-- {nil, 1013, "Tranh H¸n", 35, func_npc_getseries, 0, 16, func_npc_getpos},
		{nil, 1013, "Tranh H¸n", 80, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 80, func_npc_getseries, 1, 1, {1568, 3227}}},
	-- 22
	{1, {6, 0, nil},
		{nil, 1022, "TiÔn Than Thª ", 40, -1, 0, 20, func_npc_getpos}},
	-- 23
	{1, {6, 0, nil},
		-- {nil, 1023, "NhËm T«ng Hoµnh", 40, -1, 0, 20, func_npc_getpos}},
		{nil, 1016, "NhËm T«ng Hoµnh", 80, -1, 0, 20, func_npc_getpos}},
	-- 24
	{1, {10, 20, nil},
		{nil, 1024, "§å Tµn Sinh", 35, -1, 0, 20, func_npc_getpos}},
	-- 25
	{2, {15, 0, nil},
		{nil, 1016, "§ao Tö ", 90, func_npc_getseries, 0, 16, func_npc_getpos},
		{func_npc_proceed, func_npc_getid, func_npc_getname, 80, func_npc_getseries, 1, 1, {1568, 3227}}},
	-- 26
	{1, {9, 0, nil},
		{nil, 1018, "H¾c C©n", 35, -1, 0, 56, func_npc_getpos}},
	-- 27
	{2, {32, 32, nil},
		{nil, 1038, "NhiÕp Thİ TrÇn", 80, -1, 1, 1, {1568, 3227}},
		{nil, 1017, "Lang bæng", 100, -1, 0, 16, func_npc_getpos}},
	-- 28
	{1, {0, 0, nil},
		{nil, 1025, func_npc_get_eachname, 80, -1, 1, 8, func_npc_getpos}}, -- ph¶n ®oµn cao cÊp
		-- {nil, 1016, func_npc_get_eachname, 80, -1, 1, 8, func_npc_getpos}},
};
...
--		print(format("pos: %d, %d", px, py));
		...
		if (npc_index ~= nil and npc_index > 0) then
			...
			-- DEBUG
			local msg = format("VuotAi _Failed to AddNpcEx(%d,%d,%d,%d,%d,%d,%d,%s,%d)!!!",
...
function create_batch_npc(batch)
	...
	local msg = "XuÊt hiÖn <color=yellow>".. npc_count .."<color> con qu¸i!";
