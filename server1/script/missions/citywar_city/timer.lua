...
--Õ½¶·½øÐÐ¹ý³ÌÖÐ£¬ÏµÍ³¶¨ÆÚÍ¨ÖªÊ¯±®µÄÇé¿ö
	...
	str = format("HiÖn t¹i <color=yellow>%s<color> ®ang tranh ®o¹t quyÕt liÖt! Thêi gian cßn <color=green>%d<color> phót; hiÖn t¹i <color=green>%d<color> Long trô ®· håi phôc thuéc tÝnh ", Bil_GameCity, RestMin, MS_SYMBOLCOUNT);
