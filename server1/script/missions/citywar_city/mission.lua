...
function RunMission()
	...
	str = format("C«ng thµnh chiÕn %s chÝnh thøc b¾t ®Çu! Bªn thñ thµnh lµ %s, bªn khiªu chiÕn lµ %s. Ai sÏ giµnh th¾ng lîi chung cuéc ®©y?", Bil_GameCity, GetGamerName(1), GetGamerName(2));
	str4SubW = format("C«ng thµnh chiÕn <color=yellow>%s<color> chÝnh thøc b¾t ®Çu! Bªn thñ thµnh lµ <color=green>%s<color>, bªn c«ng thµnh lµ <color=green>%s<color>. Ai sÏ giµnh th¾ng lîi chung cuéc ®©y?", Bil_GameCity, GetGamerName(1), GetGamerName(2));
	AddGlobalNews(str);
