...
function YDBZ_ready_match()
	broadcast(format("Thêi gian b¸o danh v­ît ¶i b¶o tµng viªm ®Õ ®· kÕt thóc, xin mêi c¸c vâ l©m nh©n sü h·y chuÈn bŞ lÇn cuèi, cßn %s gi©y b¾t ®Çu.",YDBZ_READY_LIMIT_WAIT));
