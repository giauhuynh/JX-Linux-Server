...
--	bt_adddiagnpc(symbolnpcfile, FILE_SYMBOLNPC, tnpc_symbol, "");
	...
	local szMsg = "ChiÕn Tr­êng Phong Háa liªn thµnh "..cd_name.."®· b¾t ®Çu nhËn b¸o danh, "..tbDEFENCE_ANNOUNCE[citycamp].."§iÒu kiÖn tham chiÕn: §¼ng cÊp kh«ng d­íi"..CD_LEVEL_LIMIT.."cÊp"
	AddGlobalNews(szMsg)
