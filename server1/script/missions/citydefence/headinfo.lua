...
CD_LEVEL_LIMIT = 199		--×îµÍ²Î¼ÓÊØ³ÇµÈ¼¶
...
tbDEFENCE_ANNOUNCE = {
			"Ng­êi ch¬i cã thÓ ®Õn Ba L¨ng HuyÖn ®Ó b¸o danh thêi gian b¸o danh lµ 30 phót sau 30 phót khai chiÕn.",
			"Ng­êi ch¬i cã thÓ ®Õn Ba L¨ng HuyÖn ®Ó b¸o danh thêi gian b¸o danh lµ 30 phót sau 30 phót khai chiÕn.",
}
...
TOTAL_TIME = 130 * 60 * FRAME2TIME;			--150·ÖÖÓ¼ÆÊ±Ò»´Î£¬»î¶¯½áÊø
RUNGAME_TIME = 10 * 60 * FRAME2TIME / SMALL_TIME; --±¨Ãû30·ÖÖÓÖ®ºó£¬Æô¶¯
