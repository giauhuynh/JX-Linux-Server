...
function main()
	...
	if ( state ~= 1 and state ~= 2 ) then
		Say(CD_SIGNNPCNAME..":Ho¹t ®éng thñ thµnh vÉn ch­a b¾t ®Çu!", 0)
	...
	elseif ( nday ~= GetTask( TASKID_FIRE_DAY ) ) then	--ÔÊÐí±¨Ãû
		Say(CD_SIGNNPCNAME..": Lý NhÞ! Tªn tiÓu tö nhµ ng­¬i mau ®i kªu TÝn Sö l¹i ®©y, qu©n ®Þch l¹i ®¸nh ®Õn råi! ¥? Ng­¬i lµ ai? B©y giê lµ lóc nµo? Cã ng­êi ®ang tÊn c«ng thµnh cña ta, ng­¬i cßn kÐo dµi qu©n c¬ sÏ bÞ chÐm ®Çu biÕt kh«ng?", 2, "T­íng qu©n! Ta ®Õn gióp thñ thµnh!/want2joincd1", "Th«i ta sî chÕt kakaka /laughtoleave")
	else
		Say(CD_SIGNNPCNAME..": ¥? Ch¼ng ph¶i ng­¬i ®· vµo chiÕn tr­êng sao? Hay lµ ta bi hoa m¾t? enter> Th«i ®­îc råi! Ng­¬i chuÈn bÞ vµo trong ®ã ®i!", 2, "Ta muèn gia nhËp/sure2joincd", "Ta chØ ghÐ qua xem/OnCancel")
	end
end
