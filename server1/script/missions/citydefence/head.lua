...
function GameOver()
	...
	if ( GetMissionV(MS_CITYDEFENCE) == 1 ) then
		...
		--Ê¤Àû
		cd_awardall()
		AddGlobalNews("tr¶i qua chiÕn ®Êu quyÕt liÖt, "..campname.."Gi÷ thµnh thµnh c«ng! TÊt c¶ ng­êi ch¬i tham gia ®Òu nhËn quµ.")
		Msg2MSAll( MISSIONID, "tr¶i qua chiÕn ®Êu quyÕt liÖt, "..campname.."Gi÷ thµnh thµnh c«ng! TÊt c¶ ng­êi ch¬i tham gia ®Òu nhËn ®­îc quµ." )
