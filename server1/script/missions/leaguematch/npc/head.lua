...
function wlls_query_do(n_lid)
	...
	local Bil_str_rank
	if n_rank == 1 then
		Bil_str_rank = "<color=yellow>               XÕp h¹ng<color> <bclr=Blue><color=White>NhÊt<color><bclr> <pic=48>"
	elseif n_rank == 2 then
		Bil_str_rank = "<color=yellow>               XÕp h¹ng<color> <bclr=Blue><color=White>Hai<color><bclr> <pic=36>"
	elseif n_rank == 3 then
		Bil_str_rank = "<color=yellow>               XÕp h¹ng<color> <bclr=Blue><color=White>Ba<color><bclr> <pic=56>"
	elseif n_rank >= 4 then
		Bil_str_rank = "<color=yellow>               XÕp h¹ng thø<color> <color=green>"..n_rank.."<color>"
	else
		Bil_str_rank = "<color=red>VÉn ch­a xÕp h¹ng<color>"
	end
	...
	str = str .. "<enter>"..strfill_center(""..Bil_str_rank.."", 53+21).."<color>"
	wlls_descript(str)
end
