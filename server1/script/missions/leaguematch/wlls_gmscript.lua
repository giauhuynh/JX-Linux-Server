...
function Bil_GetnGroup(n_mtype)
	...
	elseif (n_phase == 4) then	--¿ªÊ¼±ÈÈü
		...
		if (n_mid <= 0) then	--Relay¸Õ¸ÕÆô¶¯£¬²»ÄÜ¿ªÊ¼±ÈÈü
			...
			if (nClose ~= 3) then	-- ²»ÊÇËùÓÐ±ÈÈü¶¼¹ØÁË
				...
				local Bil_String = "<color=yellow>Vâ l©m liªn ®Êu<color> <color=Water>"..(mod(n_mid, 100)).."<color> <color=0xa9ffe0>®ang trong giai ®o¹n b¸o danh. C¸c anh hïng muèn tham gia h·y nhanh ch©n ®Õn <color=green>Vâ l©m truyÒn nh©n<color> ë thÊt ®¹i thµnh thÞ ®Ó tham gia b¸o danh!"
				Msg2SubWorld(Bil_String)
				AddGlobalNews(str)
