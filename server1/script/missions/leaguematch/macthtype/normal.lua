...
tmp_help = {
	{
		"<t> Giíi thiÖu ",
		{
			...
			"    Lo¹i h×nh Vâ l©m liªn ®Êu lÇn nµy lµ <color=red><s><color>, ng­êi than gia ®¼ng cÊp ph¶i tõ <color=red>80~199 <color>vµ <color=red>120 trë lªn<color>. §Õn gÆp <color=red>Vâ l©m truyÒn nh©n<color>, b¸o danh thµnh lËp chiÕn ®éi, sau ®ã vµo Héi tr­êng vâ l©m liªn ®Êu tiÕn hµnh thi ®Êu",
			"    Lo¹i h×nh Vâ l©m liªn ®Êu lÇn nµy lµ <color=red><s><color>, ng­êi than gia ®¼ng cÊp ph¶i tõ <color=red>80~199 <color>vµ <color=red>120 trë lªn<color>. §Õn gÆp <color=red>Vâ l©m truyÒn nh©n<color>, b¸o danh thµnh lËp chiÕn ®éi, sau ®ã vµo Héi tr­êng vâ l©m liªn ®Êu tiÕn hµnh thi ®Êu",
		}
	},
