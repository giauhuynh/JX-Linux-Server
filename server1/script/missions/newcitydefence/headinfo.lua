...
FIRE_JOINUP_FEE = 1000;			--±¨Ãû·ÑÓÃ10wÁ½
PL_TOTALPOINT = 1
...
tbDEFENCE_ANNOUNCE = {
			"Ng­êi ch¬i cã thÓ ®Õn Ba L¨ng HuyÖn ®Ó b¸o danh thêi gian b¸o danh lµ 10 phót sau 10 phót khai chiÕn.",
			"Ng­êi ch¬i cã thÓ ®Õn Ba L¨ng HuyÖn ®Ó b¸o danh thêi gian b¸o danh lµ 10 phót sau 10 phót khai chiÕn.",
}
...
TOTAL_TIME = 40 * 60 * FRAME2TIME;			--150·ÖÖÓ¼ÆÊ±Ò»´Î£¬»î¶¯½áÊø
RUNGAME_TIME = 10 * 60 * FRAME2TIME / SMALL_TIME; --30phutsaukhidangkybatdat
LASTREPORT_TIME = 35 * 60 * FRAME2TIME / SMALL_TIME;	--ÊØ³Ç×îºó5·ÖÖÓÃ»·ÖÖÓ£¬ÌáÊ¾Ò»´ÎÊ±¼ä
CALLBOSS_ZHUSHUAI = 59 * 60 * FRAME2TIME / SMALL_TIME;	--Ö÷Ë§³öÏÖÊ±¼ä

NHOMEDEFENCE = 30 --mau ban dau cua thanh
NHOMEDEFENCE_DAMAGE = 1  --dame bi xe cong
