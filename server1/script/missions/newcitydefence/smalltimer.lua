...
function cd_callAttackCarNpc()
	...
	Msg2MSAll( MISSIONID, format("<color=yellow>%s cña ®èi ph­¬ng ®ang tiÕn c«ng vµo thµnh, mäi ng­êi h·y ra søc chèng ®ì nÕu thµnh bÞ c«ng hÕt ®iÓm sÏ b¹i trËn!!!<color>", tbSOLDIER_NAME[6]))
end
...
function cd_sendmsg2msall()
	...
	Msg2SubWorld("<color=cyan>Alo Alo c¸c anh em huynh ®Ö bªn ngoµi l¹i lÔ quan vµo thñ thµnh phô anh em chóng t«i víi nµo !!!!")
