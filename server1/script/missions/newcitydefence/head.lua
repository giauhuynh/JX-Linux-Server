...
function GameOver()
	...
	if ( GetMissionV(MS_CITYDEFENCE) == 1 ) then
		...
		AddGlobalNews("Tr¶i qua cuéc chiÕn thñ thµnh ®Ém m¸u, "..campname.."b¶o vÖ thµnh c«ng thµnh tr×!")
		Msg2MSAll( MISSIONID, "Tr¶i qua cuéc chiÕn thñ thµnh ®Ém m¸u, "..campname.."b¶o vÖ thµnh c«ng thµnh tr×!" )
                                                Msg2SubWorld("ChÕn Tr­êng<color=green> Phong Háa Liªn Thµnh<color> ChiÕn th¾ng oanh liÖt ®Þch qu©n bÞ tiªu diÖt hoµn toµn.")
		cd_writelog(date("%m-%d,%H:%M;")..campname.."Thñ thµnh thµnh c«ng, sè ng­êi=="..GetMSPlayerCount(MISSIONID, 0))
	else
		--Ê§°Ü
		AddGlobalNews("Tr¶i qua cuéc chiÕn thñ thµnh ®Ém m¸u, dï ®· cè g¾ng nh­ng cuèi cïng ®¹i qu©n vÉn chèng kh«ng l¹i ®Þch, thñ thµnh thÊt b¹i……")
		Msg2MSAll( MISSIONID, "Tr¶i qua cuéc chiÕn thñ thµnh ®Èm m¸u, dï ®· cè g¾ng nh­ng cuèi cïng ®¹i qu©n vÉn chèng kh«ng l¹i ®Þch, thñ thµnh thÊt b¹i……" )
                                                Msg2SubWorld("ChÕn Tr­êng<color=green> Phong Háa Liªn Thµnh<color> ThÊt b¹i th¶m h¹i ®¹i qu©n bÞ tiªu diÖt hoµn toµn.")
	...
	for i = 1 , 600 do 
 	...
 	for i= 1, getn(tbPlayer) do 
		...
		elseif (nsumExp >= 500000) then
			nAwardExp = floor(nsumExp / 100000) * 10000000;
		end;
		
		if (nAwardExp >= 0 and nAwardExp <= 100000000) then
