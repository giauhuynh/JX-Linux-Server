...
--	if ( Uworld1213 ~= 0 ) and ( Uworld1214 ~= 0 ) and ( Uworld1215 ~= 0 ) then  --¼¸ÖÖÈÎÎñÀàÐÍ¶¼ÒÑ¾­´¥·¢¹ýÁË
--		--Msg2Player("Äã»¹ÓÐÈÎÎñÃ»ÓÐÍê³É£¬¼ÓÓÍ¡£") ²»×ö´¦ÀíÁË
--	else
...
--			else
--				Msg2Player("Äã³É¹¦´ò¿ªÁËÒ»¸ö±¦Ïä¡£")
--			end
--		elseif ( messenger_choice == 11 ) then  --Ôö¼Ó»ý·Ö10 
--			nt_setTask(1205,Uworld1205+20)
--			tongaward_message(20);	--by Ð¡É½
--			Msg2Player("ÄãÔÚÐÅÊ¹ÈÎÎñÖÐµÄÀÛ»ý·ÖÊýÔö¼ÓÁË20·Ö£¡")
--		
--		elseif ( messenger_choice == 13 ) then  --¼õÉÙ»ý·Ö10
--			if ( Uworld1205 >= 10 ) then 
--			nt_setTask(1205,Uworld1205-10)
--			Msg2Player("ÄãÔÚÐÅÊ¹ÈÎÎñÖÐµÄÀÛ»ý·ÖÊý¼õÉÙÁË10·Ö£¡")
--			
--			end
--		elseif ( messenger_choice == 16 )  then  --Èç¹ûÃ»ÓÐ´¥·¢¹ý¶¨µã´ò¹ÖµÄÊÂ¼þ£¬´¥·¢ÔÚÄ³µã´òÌØÊâ¹ÖÎïµÄÊÂ¼þ
--			local lucky_dingdian = random(1,3)  --¿ØÖÆ¶¨µãÉÙÅ®³öÏÖ¼¸ÂÊ¼õµÍ3±¶
...
--					Msg2Player("±¦¿âµÁÔô:ÄãÄãÄã£¬ÄãÊÇÔõÃ´·¢ÏÖÎÒµØ£¬°¥Ñ½Ñ½£¬·³Ôê£¬Íµ¸ö±¦±´»¹ÓÐÈË´òÈÅ£¡È¥ËÀ°ÉÄã£¡")	
--				
...
--			nt_setTask(1213,0)
--			Msg2Player("ÄúÔÚ±¾¹ØÖÐµÃµ½µÄË«±¶¾­ÑéÊ±¼äÒÑ½áÊø£¡")
--		else
--			AddOwnExp(TUREBOSS_EXP)    --¸øÓèÒ»±¶µÄ¾­Ñé
--		end
--	end
--
--	if (tbJiaoShi2009:IsActive() == 1) then	-- 2009½ÌÊ¦½ÚµôÂäË®Ä«
--		print("123");
--		tbAwardTemplet:GiveAwardByList({szName="Ë®Ä«", tbProp={6,1,2175,1,0,0},nExpiredTime=20091203,}, "2009 Teacher's Day Messenger's Box give ink");
--	end
