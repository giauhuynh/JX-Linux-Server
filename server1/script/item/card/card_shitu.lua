...
function CallBack_ShoutuList()
	if (GetTask(5968) >= 3) then return Say("Ng­êi ®· thu nhËn 3 ng­êi ch¬i lµm ®Ö tö, ng­êi kh«ng ®­îc phĞp tiÕp nhËn thªm ng­êi ch¬i nµo n÷a!") end
	local apps = FindApprentice()
	ShoutuList(apps)
end
...
function main()
	if bilSuDoThiep ~= 1 then Say("HiÖn t¹i Tİnh n¨ng s­ ®å ®ang t¹m ®ãng, sÏ më l¹i tİnh n¨ng nµy sau khi cã th«ng b¸o!") return 1 end
