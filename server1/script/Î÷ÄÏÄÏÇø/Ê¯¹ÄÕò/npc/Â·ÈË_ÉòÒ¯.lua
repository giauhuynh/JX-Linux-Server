...
function W23_pay_yes()
	if (GetCash() >= 300) then
		...
		SetTask(23,6)
		Pay(300)
		AddNote("§· gióp A M· vµ A Toµn tr¶ hÕt nä råi, mau ®i b¸o c¸i tin tèt lµnh nµy cho hä ®i.")
		Msg2Player("§· gióp A M· vµ A Toµn tr¶ hÕt nä råi, mau ®i b¸o c¸i tin tèt lµnh nµy cho hä ®i.")
	else
		Talk(1,"","Kh«ng mang ®ñ 300 l­îng")
	end
end
