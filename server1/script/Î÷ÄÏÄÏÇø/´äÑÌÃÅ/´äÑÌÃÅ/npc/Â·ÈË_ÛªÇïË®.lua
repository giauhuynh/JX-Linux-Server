...
-- Uworld1002 = nt_getTask(1002)
	...
	Say("Ng­êi sèng trªn ®êi cÇn ph¶i biÕt tr©n träng h¹nh phóc.",3,"Ta ®Õn v× tæ chøc L©m Uyªn Nhai/Fuc_Main_TY_LeThuThuy","Ta ®Õn lµm nhiÖm vô cÊp 90/tasknpc_nity","Kh«ng hái n÷a!/no")
end
