...
Msg2SubWorld("<color=cyan>Xe tiªu cña ®¹i hiÖp <color=green>"..GetName().."<color=cyan> ®ang khëi hµnh t¹i bÕn tµu ph­îng t­êng")
	return 
end
...
function pActivity:GiveAward()
	...
	local tbAward = {
		[1]={nExp_tl=10e7},
		[2]={szName="Tói M¸u",tbProp={6,1,4352,1,0,0},nCount=1},
	}
