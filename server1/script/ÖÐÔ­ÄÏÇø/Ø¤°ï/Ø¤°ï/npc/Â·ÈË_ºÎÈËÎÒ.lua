...
function main()
	 ...
	 -- if GetTask(5995) == 8 then -- cai bang
	...
	-- tbDailog:AddOptEntry("§Ö tö muèn b¸i nghÖ ®Çu s­ vµo C¸i Bang!", bilPartner2Sect, {7})
	...
	-------------------------------------------------------------------------
	if bilFunc_ChuongMonThapDaiPhai(7, GetLevel(), GetLastFactionNumber(), GetFaction(), GetName()) then
	
		local a, b = bilFunc_ChuongMonThapDaiPhai(7, GetLevel(), GetLastFactionNumber(), GetFaction(), GetName())
	...
	tinsert(tbDes, "§Ö tö muèn b¸i nghÖ ®Çu s­ vµo C¸i Bang ph¸i!!/#bilPartner2Sect(7)")
...
function bil4i3nXS_Return()
	...
	if GetTask(5995) ~= 8 and nTongID ~= 0 then ----------
		return Talk(1,"","Ng­êi cña gi¸o ph¸i kh¸c t¹i sao l¹i ®Õn ®©y nhê cËy ta?")
	end
	if(GetCash() >= 50000) then						
		Msg2Faction("gaibang", GetName().." tõ h«m nay trë vÒ l¹i s­ m«n, mong c¸c huynh ®Ö chØ gi¸o!", GetName()) ----------
		Talk(1,"","RÊt tèt! Hoan nghªnh ng­¬i trë l¹i C¸i Bang!")
		Pay(50000)
		SetTask(5995, 0)
		SetFaction("gaibang") ------------------
		SetCamp(1) -------------------
...
function bil4i3nXS()
	...
	Msg2Faction("gaibang", GetName().." tõ h«m nay rêi khái s­ m«n, xuèng nói hµnh tÈu giang hå, mong c¸c huynh ®Ö chØ gi¸o!", GetName()) -----------
	Talk(1,"","Tèt l¾m! Hµnh tÈu giang hå nhí gióp ®ì nh÷ng ng­êi khèn khã!")
	SetTask(5995, 8) ------------
	AddNote("Rêi khái C¸i bang, tiÕp tôc hµnh tÈu giang hå. ") -------------
	Msg2Player("Ban ®· rêi khái C¸i bang, tiÕp tôc hµnh tÈu giang hå. ") -------------
	SetFaction("")
	-- SetFaction("gaibang")
	SetCamp(4)
	SetCurCamp(4)
