...
Uworld31 = GetByte(GetTask(31),1)
	if ((Uworld129 < 10) and (GetReputeLevel(GetRepute()) >= 5) and (GetLevel() >= 90) and (GetFaction() ~="wudang") and (Uworld31 ==127)) or
		(GetLevel() >= 90 and GetCamp() == 4 and GetTask(5890) == 0) then
...
function Uworld129_finish()
	if ((GetTask(5) >= 70*256) and (GetTask(5) ~= 75*256)) or
		(GetTask(5890) == 1) then
