...
-- nhËn liªn tiÕp 10 lÇn, mçi lÇn 2.000.000 exp
-- tèi ®a 10 c¸i
-- tû lÖ nhËn ®­îc c¸c vËt phÈm gi¸ trŞ

function main()
	if GetTask(5961) >= 10 then
		Talk(1, "","§¹i hiÖp ®· sö dông Hép LÔ VËt TiÓu ®¹t ®Õn giíi h¹n cho phĞp 10 c¸i, ¨n nhiÒu sÏ lµm ph¶n c«ng lùc!")
		return 1
	end
	...
	Msg2Player("Tæng sè <color=yellow>Hép lÔ vËt tiÓu<color> ®· dïng: <color=green>"..GetTask(5961).."<color> c¸i")
...
function GetDesc( nItemIdx )
	return "<color=green>VËt phÈm dïng ®Ó d©ng tÆng c¸c bËc cha mÑ nh©n ngµy lÔ Vu Lan<color><enter><color=yellow>cã gi¸ trŞ kh«ng nhá<color><enter>Sù kiÖn Vu Lan m¸y chñ Vâ L©m!"
end