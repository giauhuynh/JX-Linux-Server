...
-- nhËn ®­îc 1.600.000 ®iÓm exp
-- tèi ®a 500 c¸i
-- tû lÖ nhËn ®­îc c¸c vËt phÈm quı gi¸

function main()
	if GetTask(5962) >= 500 then
		Talk(1, "","§¹i hiÖp ®· sö dông B«ng Hång Cµi ¸o ®¹t ®Õn giíi h¹n cho phĞp 500 c¸i, ¨n nhiÒu sÏ lµm ph¶n c«ng lùc!")
		return 1
	end
	if CalcFreeItemCellCount() < 6 then Say("§¹i hiÖp cÇn ®Ó trèng hµnh trang cña m×nh 6 « míi cã thÓ dïng vËt phÈm!") return 1 end
	...
	local bil_1_1_2 = {
		...
		{bilItemParam = {0,10,5,7, 0, 0}, bilItemEndDay = 30, bilItemName = "ThÇn m· Xİch Thè"},
		{bilItemParam = {0,10,5,8, 0, 0}, bilItemEndDay = 30, bilItemName = "ThÇn m· TuyÖt ¶nh"},
		{bilItemParam = {0,10,5,9, 0, 0}, bilItemEndDay = 30, bilItemName = "ThÇn m· §İch L«"},
	}
	local bil_1_1_1 = {
		...
		{bilItemParam = {4, 771, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh HiÖp Cèt t×nh ı kÕt 1"},
		{bilItemParam = {4, 772, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh HiÖp Cèt t×nh ı kÕt 2"},
		{bilItemParam = {4, 773, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh HiÖp Cèt t×nh ı kÕt 3"},
		{bilItemParam = {4, 774, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh HiÖp Cèt t×nh ı kÕt 4"},
		{bilItemParam = {4, 775, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh HiÖp Cèt t×nh ı kÕt 5"},
		{bilItemParam = {4, 776, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh HiÖp Cèt t×nh ı kÕt 6"},
		...
		{bilItemParam = {4, 927, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc thanh xa tr­êng sam 1"},
		{bilItemParam = {4, 928, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc thanh xa tr­êng sam 2"},
		{bilItemParam = {4, 929, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc thanh xa tr­êng sam 3"},
		{bilItemParam = {4, 930, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc thanh xa tr­êng sam 4"},
		{bilItemParam = {4, 783, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc « xa ph¸t qu¸n 1"},
		{bilItemParam = {4, 784, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc « xa ph¸t qu¸n 2"},
		{bilItemParam = {4, 785, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc « xa ph¸t qu¸n 3"},
		{bilItemParam = {4, 786, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc « xa ph¸t qu¸n 4"},
		{bilItemParam = {4, 787, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc « xa ph¸t qu¸n 5"},
		{bilItemParam = {4, 788, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc « xa ph¸t qu¸n 6"},
		{bilItemParam = {4, 931, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc xİch quyªn nhuyÔn ngoa 1"},
		{bilItemParam = {4, 932, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc xİch quyªn nhuyÔn ngoa 2"},
		{bilItemParam = {4, 933, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc xİch quyªn nhuyÔn ngoa 3"},
		{bilItemParam = {4, 934, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc xİch quyªn nhuyÔn ngoa 4"},
		{bilItemParam = {4, 935, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc tö ®»ng hé uyÓn 1"},
		{bilItemParam = {4, 936, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc tö ®»ng hé uyÓn 2"},
		{bilItemParam = {4, 937, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc tö ®»ng hé uyÓn 3"},
		{bilItemParam = {4, 938, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc tö ®»ng hé uyÓn 4"},
		{bilItemParam = {4, 939, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc ng©n tµm yªu ®¸i 1"},
		{bilItemParam = {4, 940, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc ng©n tµm yªu ®¸i 2"},
		{bilItemParam = {4, 941, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc ng©n tµm yªu ®¸i 3"},
		{bilItemParam = {4, 942, 0, 0, 0, 0}, bilItemEndDay = 30, bilItemName = "M¶nh §Şnh Quèc ng©n tµm yªu ®¸i 4"},
	...
	SetTask(5962, GetTask(5962) + 1)
	AddOwnExp(1600000)
	Msg2Player("Tæng sè <color=yellow>B«ng Hång Cµi ¸o<color> ®· dïng: <color=green>"..GetTask(5962).."<color> c¸i")
	Ladder_NewLadder(10127, GetName(), GetTask(5962), 1);
	-- local bilRandomTbAwBhCA = random(1, 2)
	local bilRandomTbAwBhCA = random(1, 3)
	local bil_1
	if bilRandomTbAwBhCA == 2 then
		bil_1 = bil_1_1_1
	else
		bil_1 = bil_1_1_2
	end
	if bil_2 == 3 then
		...
		local bil_3 = random(1, getn(bil_1) + 50)
...
function GetDesc( nItemIdx )
	return "<color=green>VËt phÈm dïng ®Ó d©ng tÆng c¸c bËc cha mÑ nh©n ngµy lÔ Vu Lan<color><enter>Sù kiÖn Vu Lan m¸y chñ Vâ L©m Tİch Sö!"
end