...
function main()
	...
	if GetTask(5959) >= 5000 then
		Talk(1, "","§¹i hiÖp ®· sö dông Hoa Quèc Kh¸nh ®¹t ®Õn giíi h¹n cho phÐp 5000 c¸i, ¨n nhiÒu sÏ lµm ph¶n c«ng lùc!")
		return 1
	end
	...
	Msg2Player("Hoa Quèc Kh¸nh ®· dïng: <color=yellow>"..GetTask(5959))
