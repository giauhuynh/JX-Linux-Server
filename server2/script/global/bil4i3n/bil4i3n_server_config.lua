...
bilServerName = "Vâ L©m SHXT"
bilServerVersion = "C«ng Thµnh ChiÕn"

bilServerOpen = "Ngµy 18 th¸ng 08 - 14 giê 00 phót (2 giê tr­a)"
bilServerCloseRace = "Ngµy 2 th¸ng 09 - 19 giê 00 phót "

bilDenyAfterOpenTopRacing = 1
	bilDenyAfterOpenTopRacing_Year = "2018"
	bilDenyAfterOpenTopRacing_Month = "08"
	bilDenyAfterOpenTopRacing_Day = "19"
	bilDenyAfterOpenTopRacing_Hours = "14"
	bilDenyAfterOpenTopRacing_Minute = "00"
	-- §­a ng­êi ch¬i vµo tr¹ng th¸i phi chiÕn ®Êu víi tÊt c¶ tr­íc giê Open ®ua TOP
	-- ChØ bËt lªn khi nµo chuÈn bÞ ®ua TOP 

bilTanThuGiftCode = "Giftcode"
	-- M· th­ëng t©n thñ chç T©n thñ quan
	-- script\global\bil4i3n\bil4i3n_tanthuquan.lua

bilOpenTestGame = 0
	-- Më ho¹t ®éng Test Game, ChuÈn bÞ cho Open
	-- script\global\Â·ÈË_Àñ¹Ù.lua

bilOpenShopKTC = 1
	-- Më Kú tr©n c¸c hay kh«ng
	-- jxser\server1\script\shop\shop_checkmap.lua

bilNameOfGameMaster = "AdminÙSHXT"
	-- Tªn cña GM trong game
	-- cã quyÒn qu¶n lý nh©n vËt vµ trß chuyÖn víi Gamer
bilGMInGame = {
	{"GMÙ01ÙTrungÙGian", 1},
	{"GMÙ02ÙLiveStream", 2},
}
	
bilPassOfGameMaster = 1
	-- MËt khÈu cña Administrator
	-- Dïng cho c¸c ho¹t ®éng liªn quan ®Õn GM
	
bilOpenShopThanBiThuongNhan = 1
	-- Shop thÇn bÝ th­¬ng nh©n T­¬ng d­¬ng
	-- script\global\Â·ÈË_ÉñÃØÉÌÈËÁøÒÒ.lua

bilNPCVanSuThong = 0
	-- NPC V¹n sù th«ng - Nam nh¹c trÊn
	-- script\Á½ºþÇø\ÄÏÔÀÕò\npc\Ö°ÄÜ_ÍòÊÂÍ¨.lua
	
bilNPCDichQuan = 0
	-- NPC DÞch Quan t¹i tÊt c¶ c¸c thµnh thÞ
	-- script\global\ËÍÐÅÈÎÎñ.lua
	
bilNPCDaTau = 1
	-- NPC D· tÈu t¹i tÊt c¶ c¸c map
	-- script\global\seasonnpc.lua
	
bilNPCLongNgu = 1
	-- NPC Long ngò t¹i 8 t©n thñ th«n
	-- script\task\newtask\education\dragonfive.lua
	
bilNPCTaskHoangKim = 0 /*[[nªn t¾t]]*/
	-- NPC liªn quan ®Õn c¸c nhiÖm vô hoµng kim, chÝnh tuyÕn, ... hoµng kim nhËn ®­îc trang bÞ vµ kinh nghiÖm
	
bilAllowNvTanThu = 1
	-- HÖ thèng nhiÖm vô T©n thñ ®­îc viÕt l¹i dùa theo nguyªn b¶n cña nhiÖm vô hoµng kim chÝnh tuyÕn
	
bilNPCCongThanhQuan = 1
	-- NPC C«ng thµnh quan t¹i 8 t©n thñ th«n
	-- script\missions\citywar_global\infocenter.lua
	
bilPNCVoLamTruyenNhan = 1
	-- NPC Vâ l©m truyÒn nh©n t¹i 7 ®¹i thµnh thÞ
	-- \script\global\Â·ÈË_ÎäÁÖAË´«ÈË.lua
	
bilNPCBinhBinhCoNuong = 1
	-- NPC B×nh b×nh c« n­¬ng t¹i biÖn kinh
	-- \script\missions\yandibaozang\npc\yandibaozang_main.lua

bilNPCNhipThiTran = 1
	-- NPC NhÝp thÝ trÇn t¹i 7 ®¹i thµnh thÞ
	-- script\task\tollgate\killer\nieshichen.lua
	
bilNewWorldPlayer2PosBoss = 1
	-- Chøc n¨ng tù ®éng chuyÓn ng­êi ch¬i ®Õn chç Boss S¸t thñ khi nhËn nhiÖm vô
	-- \script\task\tollgate\killer\nieshichen.lua
	
bilPhongLangDo = 1
	--Ho¹t ®éng bÕn thuyÒn phong l¨ng ®é
	-- script\missions\fengling_ferry\fld_head.lua
	
bilNPCTongKim = 1
	-- NPC Ho¹t ®éng tèng kim
	-- script\battles\battlejoin.lua
	
bilSuDoThiep = 1
	-- TÝnh n¨ng cña vËt phÈm s­ ®å thiÕp
...
bilDropKyTranDiBaO = 1
	-- Cho phÐp r¬i ®å phæ hoµng kim, AB §Q, K.Th¹ch trªn c¸c BOSS hoÆc NPCs
	-- \script\\global\\bil4i3n\\bil4i3n_droprate.lua
	
bilAllowCheTaoDoTim = 1
	-- Cho phÐp chÕ t¹o trang bÞ tÝm b»ng huyÒn tinh chç thî rÌn
...
bilNativePlace2ManualMap = 0
	...
	-- §­a nh©n vËt míi khëi t¹o vÒ vÞ trÝ chØ ®Þnh b»ng tay
	-- script\global\login.lua
	
bilAllowOnTimerOnPlayer = 1
	-- bilAllowOnTimerOnPlayer_Time = 480	-- §¬n vÞ gi©y
	bilAllowOnTimerOnPlayer_Time = {480, 1200}
	bilAllowOnTimerOnPlayer_SaveNow = 1		-- Chän 1 trong 2 SaveQuickly hoÆc SaveNow
	bilAllowOnTimerOnPlayer_SaveQuickly = 0
	bilAllowOnTimerOnPlayer_CheckTitle = 0
	-- Cho phÐp g¸n OnTimer kiÓm tra ng­êi ch¬i theo thêi gian hay kh«ng
	-- script\global\bil4i3n\bil4i3n_ontimer_player.lua
	
bilAllowHorseUpgrade = 1
	-- Chøc n¨ng n©ng cÊp ngùa t¹i B¸n ngùa D­¬ng ch©u
	-- \script\__\npc_dc_ban_ngua.lua
	
bilAllowPhucLoiCaNhan = 1
	-- Chøc n¨ng Phóc lîi c¸ nh©n trong CÈm nang ®ång hµnh
	-- \script\global\bil4i3n\bil4i3n_phuc_loi_ca_nhan.lua
	
bilAllowBossTieuHoangKim = 1
	-- Ho¹t ®éng Boss Tinh Anh ë c¸c th«n trÊn
	-- \script\global\bil4i3n\bil4i3n_boss_tinh_anh.lua
	
bilAllowTransFullMapInNPC = 1
	-- Cho phÐp chän di chuyÓn ®Õn khu vùc luyÖn c«ng víi tÊt c¶ c¸c map
	-- \script\global\station.lua
	
bilAllowVerifyClient = 0
	-- Khëi ®éng hÖ thèng kiÓm tra path game cña ng­êi ch¬i
	-- \script\global\bil4i3n\bil4i3n_verify_client.lua
	
bilAllowOnTimerAutoChat = 0
	-- Khëi ®éng tÝnh n¨ng thiÕt lËp Auto rao b¸n trªn kªnh ch¸t
	-- \script\global\bil4i3n\bil4i3n_ontimer_player_chat.lua
	
bilAllowCheckIpBattleSongJin = 1
	-- BËt tÝnh n¨ng kiÓm tra IP ng­êi ch¬i khi tham gia Tèng kim, chèng post ®iÓm
	-- \script\global\bil4i3n\bil4i3n_check_songjin.lua
	
bilGetIPAdressWithProtocol = 0
	-- LÊy ®Þa chØ IP thËt cña user khi m¸y chñ sö dông proxy
	-- \script\global\bil4i3n\bil4i3n_client_ip.lua
	
bilAllowUyThacBachCauHoan = 0
	-- Cho phÐp ñy th¸c nhËn kinh nghiÖm b»ng B¹ch c©u hoµn
	-- \script\global\bil4i3n\bil4i3n_autooffline4player.lua
	
bilAllowNumWindowOnIPAdress = 0 -- sè l­îng cöa sæ cho phÐp / 0 = ®ãng giíi h¹n
	-- Giíi h¹n cöa sæ game trªn mçi ®Þa chØ IP
	-- \script\global\bil4i3n\bil4i3n_limit_window_on_ip.lua
	
bilAllowDropMagicItemManual = {
	isOpen = 1,
	version = 1,
	-- Më r¬i vËt phÈm víi thuéc tÝnh ma ph¸p ®· ®­îc ®iÒu chØnh.
	-- R¬i ë c¸c tÝnh n¨ng: Boss tinh anh, tiÓu hoµng kim, hoµng kim, b·i train th«ng th­êng, ...
}
...
bilDenyNewPlayerGotoMap = {
	...
	MapLevelMax = 90,
	StepLevel = 10,
	-- Kh«ng cho phÐp nh©n vËt ch­a gia nhËp m«n ph¸i hoÆc nh©n vËt ch÷ tr¾ng tham gia b¶n ®å luyÖn c«ng
...
bilDenyLevelPlayerGotoMap = {
	...
	MapLevelMax = 90,
	StepLevel = 10,
	-- Kh«ng cho phÐp c¸c nh©n vËt ch­a ®ñ cÊp ®é cña b¶n ®å tham gia luyÖn c«ng
	-- \script\maps\newworldscript_default.lua
}

bilRandomMapPos = 1
	-- TiÕn vµo b¶n ®å train sÏ ngÉu nhiªn täa ®é gÇn cæng vµo, tr¸nh t×nh tr¹ng chÆn cæng
	-- HiÖn hç trî cho c¸c b¶n ®å tõ 7x ®Õn 9x
	
bilSupportForMenberDoingMissionOfSeasonNPC = 1
	-- Hç trî cho nh©n vËt ®ang lµm NV d· tÈu, t¨ng tû lÖ r¬i ra thÇn bÝ ®å chÝ, ¸p dông duy nhÊt trªn b¶n ®å vµ ch­a ®ñ sè l­îng
