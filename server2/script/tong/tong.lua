...
----------------------------------------------------------------------------------------------------------------------------------------------------------
	local a, b = GetTask(5877), GetCurServerTime()
	local c = 3
	
	if (b - a) < c then
		Msg2Player("Trong vßng 3 gi©y sau khi thay ®æi phe ph¸i cña bang héi kh«ng ®­îc phÐp thay ®æi tiÕp, thêi gian lÇn kÕ: "..(c - (b - a)).." gi©y!")
		return 0
	end
