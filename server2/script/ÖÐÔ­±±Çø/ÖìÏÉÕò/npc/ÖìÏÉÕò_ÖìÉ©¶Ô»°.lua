...
function main()
	...
	if (UTask_world46==0)  then
		Say("Ng­¬i cã thÊy «ng chång quû nhµ ta ch¹y ®i ®©u kh«ng? ¤i! H«m nay còng kh«ng chŞu ë nhµ, võa nãi hai c©u «ng ta ®· ch¹y mÊt, ch¾c l¹i ®i uèng r­îu ®©u ®ã råi. Ng­¬i cã thÓ gióp ta t×m «ng Êy vÒ kh«ng?", 2, "§­îc ta sÏ gióp/yes", "Kh«ng quan t©m ®Õn chuyÖn vî chång ng­êi kh¸c/no")
