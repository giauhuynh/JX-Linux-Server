...
function main()
	...
	if (UTask_world40 == 1) then
		...
		AddNote("TiÓu Hïng cho biÕt chiÕc nhÉn cña Song Song c« n­¬ng cã thÓ ®· bŞ ng­êi ¨n mµy lÊy ®i.")
		SetTask(68,2)
		Msg2Player("TiÓu Hïng cho biÕt chiÕc nhÉn cña Song Song c« n­¬ng cã thÓ ®· bŞ ng­êi ¨n mµy lÊy ®i.")
	else
		i = random(0,1)
		if (i == 0) then
			Talk(1,"","Song Song tû tû rÊt tèt víi ta.")
		else
			Talk(1,"","Ta c¶m thÊy ng­êi ¨n mµy ë phİa T©y trÊn cã c¸i g× ®ã h¬i kú qu¸i.")
		end
	end
end;
