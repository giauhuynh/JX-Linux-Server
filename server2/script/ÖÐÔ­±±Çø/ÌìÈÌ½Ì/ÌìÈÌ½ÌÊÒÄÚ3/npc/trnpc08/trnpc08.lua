...
function main()
	...
	if GetTask(5905) == 56 then
		return bilFuc_Main_TNGt3_DoanMocDue()
	end
...
-- ĞÂÈÎÎñÏµÍ³ÓëĞ°½ÌÖ÷ÏßÏà¹ØµÄ½Å±¾ --
	...
	elseif (UTask_tr >= 70*256) then							--ÒÑ¾­³öÊ¦
		...
		Skill150Dialog("Vâ c«ng vèn kh«ng kh«ng cã chİnh tµ, chØ cã m¹nh yÕu, chuyÖn giang hå, n¨ng giµ vŞ chi, thiªn h¹ chi thÕ, c­êng gi¶ ch­ëng chi.")
	end
end;
