...
--	 end;
	...
	tbDailog.szTitleMsg = "T©y S¬n tiÓu nhŞ: §¹i hiÖp muèn ®i ®Õn Vi S¬n ®¶o? Tr­íc tiªn h·y giao nép 1 lÖnh bµi vi s¬n ®¶o míi cã thÓ ®i ®Õn Vi S¬n ®¶o ®­îc."
...
function task007()
	if (GetLevel() < 90) then
		Say("T©y S¬n tiÓu nhŞ: D­íi cÊp 90 kh«ng thÓ ®i Vi S¬n ®¶o ®­îc!",0);
		return
	end
	
	GiveItemUI("Giao diÖn tr¶ phİ.","Xin h·y bá  lÖnh bµi vi s¬n ®¶o vµo « bªn d­íi.", "task008", "no")
--	Uworld1064 = nt_getTask(1064)
--	nt_setTask(1064,0)
--	SetFightState(1);
