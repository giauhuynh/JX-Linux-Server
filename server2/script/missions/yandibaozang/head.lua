...
--		{30,1,{6,1,1606,1,0,0},1,"Viªm §Õ §å §»ng",1}			--ËéÆ¬
	...
	{			
		...
		[1]={{szName="HuyÒn Tinh",tbProp={6,1,157,4,0,0},nCount=5,},},
		[2]={{szName="Thñy tinh",tbProp={4,239,1,1,0,0},nCount=1,},},
		[3]={{szName="TTK",tbProp={6,1,22,1,0,0},nCount=3,},},
		[4]={{szName="Tinh Hång",tbProp={4,353,1,1,0,0},nCount=3,},},
...
YDBZ_tbaward_item_ex = 
{
	...
	[1] = {szName="Ngò Hoa Ngäc Lé Hoµn",tbProp={1, 2, 0, 5, 0, 0}},		-- Ñ×µÛÃØ±¦pÓĞ´ıĞŞ¸Ä
}
