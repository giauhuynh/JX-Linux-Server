...
function BigBoss:BigBossDeath(nNpcIndex)
	...
	if (nTeamSize > 1) then
		for i=1,nTeamSize do
			...
			doFunByPlayer(GetTeamMember(i), PlayerFunLib.AddExp, PlayerFunLib, 10000000, 0, format("%s ph«n th≠Îng","Ph«n th≠Îng kinh nghi÷m cho ng≠Íi c„ c´ng k›ch mπnh nh t vµo ßÈc C´ Thi™n Phong"));
		end
	else -- “ª∏ˆ»À
		szName = GetName();
	...
	for i=1,nCount do
		doFunByPlayer(tbRoundPlayer[i], PlayerFunLib.AddExp, PlayerFunLib, 5000000, 0, format("%s ph«n th≠Îng","Ph«n th≠Îng kinh nghi÷m cho ng≠Íi Æ¯ng g«n khi Æ∂ bπi ßÈc C´ Thi™n Phong"));
	end
