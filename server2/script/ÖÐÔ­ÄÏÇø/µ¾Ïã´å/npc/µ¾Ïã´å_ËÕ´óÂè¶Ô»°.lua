...
function main()
	...
	if ((UTask_world43==0) and (GetLevel() >= 3)) then		-- ¼ÓÈëµÈ¼¶ÏŞÖÆ
		Talk(2, "select", "Hõ! §øa con ngç nhŞch cña ta, ng­¬i muèn ta ph¶i thÕ nµo?")
	elseif (UTask_world43==2) then
		Talk(2, "", "Ta ®· khuyªn T« Trung cè g¾ng häc hµnh, ng­êi kh«ng nªn lo l¾ng n÷a.", "Tèt qu¸! L·o th©n kh«ng biÕt lÊy g× ®Ó c¶m ¬n, ®©y lµ Kim S¸ng D­îc ng­¬i nhËn ®i!")
	...
	elseif (UTask_world43==3) then
		Talk(2, "", "§¹i Ma! Ta biÕt T« Trung cã chİ khİ, huynh Êy muèn giÕt ®Şch trªn chiÕn tr­êng, nam nhi chİ t¹i bèn ph­¬ng. H·y ®Ó huynh Êy lµ theo lı t­ëng cña m×nh.", "¤i, con ®· lín ta kh«ng thÓ gi÷ ®­îc! Nã cã chİ lín, ta lµm mÑ còng kh«ng thÓ ng¨n c¶n, c¶m ¬n ng­¬i ®· gióp ta hiÓu nã. Kim s¸ng d­îc nµy ng­¬i lÊy ®i!")
		...
		Msg2Player("NhËn ®­îc 3 b×nh Kim S¸ng D­îc")
		AddRepute(4)
		Msg2Player("Thanh thÕ giang hå cña b¹n t¨ng thªm 4 ®iÓm ")
	else	
...
function select()
Say("Nã vèn lµ ®øa nghiªm tóc miÖt mµi ®Ìn s¸ch, gÇn ®©y l¹i muèn tßng qu©n giÕt giÆc, rèt cuéc kh«ng biÕt nã nghÜ g× n÷a?", 2, "Ta gióp ba ®i hái nã/yes", "ViÖc nµy ta còng kh«ng biÕt/no")
end
