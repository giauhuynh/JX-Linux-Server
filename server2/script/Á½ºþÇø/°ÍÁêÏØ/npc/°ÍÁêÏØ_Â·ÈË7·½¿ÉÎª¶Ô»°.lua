...
if (i == 1) then
Say("Thiªn V­¬ng Bang chİnh lµ cøu c¸ch cña chóng ta, nÕu kh«ng cã hä thÕ thiªn hµnh ®¹o, chóng ta h¼n ®· bŞ bän tham quan nhòng nhiÔu råi! ",0)
return
end;
